...
if __name__ == "__main__":
    ...
    yWidth, yLength = math.ceil(len(y[0]) / windowSize) * windowSize, math.ceil(len(y) / windowSize) * windowSize
    ...
    cWidth, cLength = math.ceil(len(cbSub[0]) / windowSize) * windowSize, math.ceil(len(cbSub) / windowSize) * windowSize
